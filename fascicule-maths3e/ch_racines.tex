...
\end{tikzpicture}
\fig{Figure — Dans un carré de côté $1$, la diagonale mesure exactement $\sqrt2$ (on le
justifiera avec le théorème de Pythagore).}
\end{illus}
...
\end{tikzpicture}
\fig{Figure — Simplifier $\sqrt{72}$ : on factorise $72$ par le plus grand carré parfait
possible ($36$), puis on sépare la racine.}
\end{illus}
...
\end{tikzpicture}
\fig{Figure — Placement approché de $\sqrt2,\sqrt3,\sqrt5,\sqrt7$ sur la droite graduée :
chacune est encadrée par deux entiers consécutifs.}
\end{illus}
