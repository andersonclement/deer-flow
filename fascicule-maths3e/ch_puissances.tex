...
\end{tikzpicture}
\fig{Figure — Les trois règles de base : on additionne, on soustrait ou on multiplie les
exposants selon l'opération.}
\end{illus}
...
\end{tikzpicture}
\fig{Figure — $(2\times3)^{2}=6^{2}=36$ petites cases, regroupées en $2^{2}=4$ blocs de
$3^{2}=9$ cases : on retrouve $2^{2}\times3^{2}=4\times9=36$.}
\end{illus}
...
\end{tikzpicture}
\fig{Figure — Échelle des ordres de grandeur, de l'infiniment petit à l'infiniment grand
(tailles en m, effectifs en nombre d'individus).}
\end{illus}
