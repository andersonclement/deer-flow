\chapter{La respiration et ses infections}
...
respiratoire, les mouvements qui l'animent, les échanges gazeux qui s'y déroulent, puis
les principales infections et maladies qui peuvent l'affecter.}
\vspace{8pt}
...
\section{Les infections et maladies respiratoires}

\begin{definition}[Bronchite]
Une \textbf{bronchite} est une \textbf{inflammation des bronches}, souvent d'origine
virale, qui provoque toux et gêne respiratoire en réduisant le passage de l'air.
\end{definition}

\begin{definition}[Pneumonie]
Une \textbf{pneumonie} est une infection des \textbf{alvéoles pulmonaires}, due à une
bactérie ou un virus. Les alvéoles se remplissent de liquide, ce qui gêne fortement les
échanges gazeux (l'hématose) et peut entraîner un essoufflement important.
\end{definition}

\begin{definition}[Tuberculose]
La \textbf{tuberculose} est une maladie infectieuse \textbf{chronique}, due à une
bactérie (le bacille de Koch), qui touche principalement les poumons. Elle se
transmet par \textbf{voie respiratoire} (toux d'une personne malade) et se soigne par
un traitement antibiotique \textbf{long} (plusieurs mois).
\end{definition}

\begin{definition}[Asthme]
L'\textbf{asthme} est une maladie \textbf{chronique, non infectieuse}, due à une
inflammation des bronches qui se contractent et se rétrécissent lors des
\textbf{crises} : l'air passe alors difficilement, provoquant une gêne respiratoire
sifflante. Les crises peuvent être déclenchées par un allergène, un effort physique,
ou la pollution de l'air.
\end{definition}

\begin{propriete}[Infectieuses ou non]
\begin{center}
\small
\begin{tabular}{lcc}
\toprule
& \textbf{Origine} & \textbf{Durée} \\
\midrule
Bronchite & infectieuse (souvent virale) & courte \\
Pneumonie & infectieuse (bactérie/virus) & courte à moyenne \\
Tuberculose & infectieuse (bactérie) & chronique \\
Asthme & non infectieuse (inflammatoire) & chronique, par crises \\
\bottomrule
\end{tabular}
\end{center}
\end{propriete}
...
\begin{remarque}
Piège fréquent : contrairement à la bronchite, à la pneumonie et à la tuberculose,
l'asthme n'est \textbf{pas} causé par un microbe : c'est une maladie inflammatoire des
bronches, dont les crises peuvent être déclenchées par des facteurs très divers
(allergènes, effort, air froid, pollution).
\end{remarque}

\begin{exemple}
Une toux persistante accompagnée de fièvre et de crachats évoque une infection
(pneumonie ou tuberculose selon la durée des symptômes), alors qu'une gêne
respiratoire sifflante déclenchée par un effort évoque plutôt une crise d'asthme.
\end{exemple}
...
\textbf{Infections/maladies.} Bronchite (bronches), pneumonie (alvéoles), tuberculose
(chronique, bacille de Koch) : infectieuses. Asthme (crises, bronches) : non
infectieux.\\[4pt]
\textbf{Piège fréquent.} L'air expiré contient encore du dioxygène ($\approx16\,\%$) ;
l'asthme, contrairement aux trois autres, n'est pas une infection.
\end{synthese}
...
\methode{Distinguer une infection respiratoire d'une maladie non infectieuse}
Vérifier si un microbe (bactérie ou virus) est en cause (bronchite, pneumonie,
tuberculose) ou si la maladie résulte d'une inflammation chronique des bronches sans
microbe (asthme).
\begin{exemple}
Une crise déclenchée par la présence de pollen évoque l'asthme, une maladie
...
\rubrique{Infections et maladies respiratoires}
\exo{}\diff{1} Qu'est-ce qu'une bronchite ?

\exo{}\diff{2} Pourquoi une pneumonie gêne-t-elle les échanges gazeux ?

\exo{}\diff{2} Quel agent pathogène cause la tuberculose ?

\exo{}\diff{2} L'asthme est-il une maladie infectieuse ? Justifier.
...
\rubrique{Infections et maladies respiratoires}
\exo{}\diff{3} Expliquer pourquoi la tuberculose nécessite un traitement antibiotique
particulièrement long.

\exo{}\diff{2} Pourquoi la tuberculose se transmet-elle facilement dans un lieu
fermé et mal ventilé ?

\exo{}\diff{3} Un élève affirme qu'une crise d'asthme est toujours due à un microbe.
...
\sujetbac[Infections et maladies respiratoires]
\begin{enumerate}[label=\arabic*)]
\item Définis la bronchite et la pneumonie, en précisant l'organe atteint dans
chaque cas.
\item Quel agent pathogène cause la tuberculose ? Comment se transmet-elle ?
\item L'asthme est-il causé par un microbe ? Justifie.
\item Cite un facteur qui peut déclencher une crise d'asthme.
\end{enumerate}
...
Une inflammation des bronches, souvent d'origine virale, qui gêne le passage de
l'air.

\corrige{de l'exercice 13}
Car les alvéoles se remplissent de liquide, ce qui gêne le passage des gaz entre
l'air et le sang.

\corrige{de l'exercice 14}
Une bactérie appelée bacille de Koch.

\corrige{de l'exercice 15}
Non, c'est une maladie inflammatoire chronique des bronches, non causée par un
microbe.

\corrige{de l'exercice 16}
Pour offrir une très grande surface d'échange avec le sang et maximiser l'hématose.

\corrige{de l'exercice 17}
Car l'inflammation réduit le diamètre des bronches, ce qui gêne le passage de l'air.

\corrige{de l'exercice 18}
Car les muscles en activité consomment davantage de dioxygène et produisent
davantage de dioxyde de carbone à évacuer.

\corrige{de l'exercice 19}
$f=\dfrac{45}3=15$ mvt/min.

\corrige{de l'exercice 20}
La fréquence double après l'effort ; les muscles, plus actifs, ont besoin de plus de
dioxygène et produisent plus de dioxyde de carbone.

\corrige{de l'exercice 21}
Car tout le dioxygène de l'air inspiré n'est pas capté par le sang à chaque
mouvement respiratoire.

\corrige{de l'exercice 22}
Car l'organisme produit en permanence du dioxyde de carbone, cédé au sang puis à
l'air alvéolaire.

\corrige{de l'exercice 23}
Hors de l'eau, l'hématose ne peut plus se faire normalement, faute d'organe adapté
aux échanges gazeux dans l'air.

\corrige{de l'exercice 24}
$D=0{,}5\times25=12{,}5$ L/min.

\corrige{de l'exercice 25}
$f=\dfrac D{V_c}=\dfrac{12}{0{,}6}=20$ mvt/min.

\corrige{de l'exercice 26}
Car le volume courant $V_c$ et la fréquence respiratoire $f$ augmentent tous les
deux pendant l'effort.

\corrige{de l'exercice 27}
Car le bacille de Koch se multiplie lentement ; un traitement court laisserait
survivre des bactéries et favoriserait l'apparition de résistances.

\corrige{de l'exercice 28}
Car l'air, peu renouvelé, concentre davantage les bactéries expulsées par la toux
d'une personne malade.

\corrige{de l'exercice 29}
C'est faux : l'asthme est une maladie inflammatoire chronique des bronches, non
causée par un microbe ; ses crises peuvent être déclenchées par un allergène, un
effort ou la pollution.
...
\corrige{du sujet 4}
1) Bronchite : inflammation des bronches. Pneumonie : infection des alvéoles
pulmonaires.\\
2) Le bacille de Koch ; elle se transmet par voie respiratoire (toux d'une personne
malade).\\
3) Non, c'est une maladie inflammatoire chronique, non causée par un microbe.\\
4) Par exemple : un allergène (ou un effort physique, ou la pollution de l'air).
