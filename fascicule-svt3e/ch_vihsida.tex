...
étudié dans le chapitre précédent. Comprendre son fonctionnement, ses modes de
...
progressivement les \textbf{lymphocytes T}, des cellules essentielles de la réponse
spécifique (voir chapitre précédent).
\end{definition}
